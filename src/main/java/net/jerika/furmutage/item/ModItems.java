...
public class ModItems {
    ...
    public static final RegistryObject<Item> DEEPSLATE_LATEX_SQUID_DOG_SPAWN_EGG = ITEMS.register("deepslate_latex_squid_dog_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.DEEPSLATE_LATEX_SQUID_DOG, 0xDDEAEA, 0xDDEAEA,
                    new Item.Properties()));
    public static final RegistryObject<Item> DEEP_CAVE_HYPNO_CAT_SPAWN_EGG = ITEMS.register("deep_cave_hypno_cat_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.DEEP_CAVE_HYPNO_CAT, 0xDDEAEA, 0xDDEAEA,
                    new Item.Properties()));
    ...
    public static final RegistryObject<Item> LOOSE_BEHEMOTH_HAND_SPAWN_EGG = ITEMS.register("loose_behemoth_hand_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.LOOSE_BEHEMOTH_HAND, 0xDDEAEA, 0xDDEAEA,
                    new Item.Properties()));
    public static final RegistryObject<Item> LOOSE_SQUID_DOG_LIMB_SPAWN_EGG = ITEMS.register("loose_squid_dog_limb_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.LOOSE_SQUID_DOG_LIMB, 0xF5E6E6, 0xE8A0A0,
                    new Item.Properties()));
    ...
    public static final RegistryObject<Item> TAINTED_WHITE_CHEST_BOAT = ITEMS.register("tainted_white_chest_boat",
            () -> new net.jerika.furmutage.item.custom.TaintedBoatItem(() -> ModEntities.TAINTED_WHITE_CHEST_BOAT.get(), new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> TAINTED_DARK_CHEST_BOAT = ITEMS.register("tainted_dark_chest_boat",
            () -> new net.jerika.furmutage.item.custom.TaintedBoatItem(() -> ModEntities.TAINTED_DARK_CHEST_BOAT.get(), new Item.Properties().stacksTo(1)));
