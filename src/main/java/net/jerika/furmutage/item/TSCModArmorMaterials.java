...
public enum TSCModArmorMaterials implements ArmorMaterial {
    ...
    TSCModArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public String getName() {
        return furmutage.MOD_ID + ":" + this.name;
    }
