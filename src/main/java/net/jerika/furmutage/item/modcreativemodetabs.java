    ...
    public static final RegistryObject<CreativeModeTab> FURMUTAGE_TAB = CREATIVE_MODE_TABS.register("furmutage",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.THUNDERIUM.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModBlocks.TAINTED_WHITE_FENCE.get());
                        ...
                        output.accept(ModBlocks.TAINTED_WHITE_SPOTTED_MUSHROOM.get());
                        output.accept(ModBlocks.TAINTED_WHITE_DRIP_MUSHROOM.get());
                        output.accept(ModBlocks.TAINTED_WHITE_ROSELIGHT_FLOWER.get());
                        output.accept(ModBlocks.TAINTED_WHITE_CRYSTAL_BLUE_FLOWER.get());
                        output.accept(ModBlocks.TAINTED_WHITE_REED.get());

                        output.accept(ModBlocks.TAINTED_DARK_GRASS.get());
                        output.accept(ModBlocks.TAINTED_DARK_DIRT.get());
                        ...
                        output.accept(ModBlocks.TAINTED_DARK_FENCE.get());
                        ...
                        output.accept(ModBlocks.TAINTED_DARK_TALL_GRASS.get());
                        output.accept(ModBlocks.TAINTED_DARK_GRASS_FOLIAGE.get());
                        output.accept(ModBlocks.TAINTED_DARK_ROSELIGHT_FLOWER.get());
                        output.accept(ModBlocks.TAINTED_DARK_CRYSTAL_BLUE_FLOWER.get());
                        output.accept(ModBlocks.DARK_LYNCHING_VINE.get());
