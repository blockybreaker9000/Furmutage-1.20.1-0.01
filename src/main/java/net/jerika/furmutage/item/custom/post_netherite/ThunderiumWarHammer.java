...
public class ThunderiumWarHammer extends TSCElectriumWeaponAxes {
    public ThunderiumWarHammer() {
    ...
    public float getDestroySpeed(ItemStack itemStack, BlockState blockState) {
        return blockState.is(BlockTags.MINEABLE_WITH_AXE) ? 1.5F : 1.0F;
    }
    ...
    public double attackDamage() {
        return 30 + Tiers.NETHERITE.getAttackDamageBonus();
    }
