...
import net.jerika.furmutage.item.TSCElectriumWeaponBats;
...
public class ThunderiumThornBat extends TSCElectriumWeaponBats {
    public ThunderiumThornBat() {
        super(new Properties().durability(1200));
    }
    ...
    public double attackDamage() {
        return 8 + Tiers.DIAMOND.getAttackDamageBonus();
    }
