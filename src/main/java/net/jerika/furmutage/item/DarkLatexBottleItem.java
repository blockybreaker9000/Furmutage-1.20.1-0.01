...
public class DarkLatexBottleItem extends Item {
    public DarkLatexBottleItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            DarkLatexBottleProjectile projectile = new DarkLatexBottleProjectile(level, player);
