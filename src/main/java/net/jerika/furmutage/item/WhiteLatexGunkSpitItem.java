...
public class WhiteLatexGunkSpitItem extends Item {

    public WhiteLatexGunkSpitItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            WhiteLatexGunkSpitProjectile projectile = new WhiteLatexGunkSpitProjectile(level, player);
