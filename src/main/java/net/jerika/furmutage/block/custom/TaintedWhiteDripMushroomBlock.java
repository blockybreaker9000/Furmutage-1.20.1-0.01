...
/**
 * Tainted white drip mushroom that grows on tainted white grass.
 */
public class TaintedWhiteDripMushroomBlock extends BushBlock {
    public TaintedWhiteDripMushroomBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
