...
public class ThunderiumCrystalShardBlock extends Block {
    private static final VoxelShape SHAPE = Block.box(4.0D, 0.0D, 4.0D, 12.0D, 8.0D, 12.0D);
    
    public ThunderiumCrystalShardBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
        ...
        if (builder.getOptionalParameter(net.minecraft.world.level.storage.loot.parameters.LootContextParams.TOOL) != null) {
            ...
            if (tool != null) {
                ...
                if (isPickaxe) {
                    ...
                    drops.add(new ItemStack(ModItems.THUNDERIUM_GLASS_SHARD.get(), amount));
                }
            }
        }
