...
public class DeepSlateLatexSquidDogFemaleModel extends AdvancedHumanoidModel<DeepSlateLatexSquidDog> implements DoubleArmedModel<DeepSlateLatexSquidDog> {
    ...
    private final HumanoidAnimator<DeepSlateLatexSquidDog, DeepSlateLatexSquidDogFemaleModel> animator;

    public DeepSlateLatexSquidDogFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void translateToUpperHand(DeepSlateLatexSquidDog entity, HumanoidArm arm, PoseStack poseStack) {
        this.getArm(arm).translateAndRotate(poseStack);
        poseStack.translate(0.0, (this.animator.armLength - 12.0f) / 20.0, 0.0);
    }

    @Override
    public void translateToLowerHand(DeepSlateLatexSquidDog entity, HumanoidArm arm, PoseStack poseStack) {
        this.getOtherArm(arm).translateAndRotate(poseStack);
        poseStack.translate(0.0, (this.animator.armLength - 12.0f) / 20.0, 0.0);
    }

    @Override
    public void setupHand(DeepSlateLatexSquidDog entity) {
        animator.setupHand();
    }

    @Override
    public HumanoidAnimator<DeepSlateLatexSquidDog, DeepSlateLatexSquidDogFemaleModel> getAnimator(DeepSlateLatexSquidDog entity) {
        return animator;
    }
