...
public class GiantPureWhiteLatexModel<T extends GiantPureWhiteLatexEntity> extends AdvancedHumanoidModel<T> {
	...
	public GiantPureWhiteLatexModel(ModelPart root) {
		super(root);
		...
		// Tail is a direct child of Torso (based on createBodyLayer)
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(28, 55).addBox(-2.0F, -1.2F, -1.95F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.5F, 1.5F, 1.8326F, 0.0F, 0.0F));
	...
	@Override
	public HumanoidAnimator<T, GiantPureWhiteLatexModel<T>> getAnimator(T entity) {
		return animator;
	}
}
