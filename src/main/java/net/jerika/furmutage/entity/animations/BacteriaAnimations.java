 ...
 * @author Author
 */
public class BacteriaAnimations {
	...
	public static final AnimationDefinition idle2 = AnimationDefinition.Builder.withLength(0.5417F).looping()
		...
		.addAnimation("LeftLegs2", new AnimationChannel(AnimationChannel.Targets.POSITION, 
		...
		.addAnimation("rightlegs2", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, 2.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
