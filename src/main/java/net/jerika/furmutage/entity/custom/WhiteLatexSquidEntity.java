...
/**
 * White latex infected version of a squid. Now hostile.
 */
public class WhiteLatexSquidEntity extends Squid {
    public WhiteLatexSquidEntity(EntityType<? extends Squid> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.WHITE_LATEX_SQUID_AMBIENT.get();
    }
}
