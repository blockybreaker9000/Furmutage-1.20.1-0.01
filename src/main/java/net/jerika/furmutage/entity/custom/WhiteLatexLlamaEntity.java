...
/**
 * White latex infected version of a llama. Now hostile.
 */
public class WhiteLatexLlamaEntity extends Llama {
    public WhiteLatexLlamaEntity(EntityType<? extends Llama> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.WHITE_LATEX_LLAMA_AMBIENT.get();
    }
}
