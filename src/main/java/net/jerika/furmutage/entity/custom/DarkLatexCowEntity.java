...
/**
 * Dark latex infected version of a cow. Now hostile.
 */
public class DarkLatexCowEntity extends Cow {
    public DarkLatexCowEntity(EntityType<? extends Cow> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.DARK_LATEX_COW_AMBIENT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.DARK_LATEX_COW_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.DARK_LATEX_COW_DEATH.get();
    }
}
