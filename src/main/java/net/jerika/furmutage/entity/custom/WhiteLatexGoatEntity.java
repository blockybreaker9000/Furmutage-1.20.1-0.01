...
/**
 * White latex infected version of a goat. Now hostile.
 */
public class WhiteLatexGoatEntity extends Goat {
    public WhiteLatexGoatEntity(EntityType<? extends Goat> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.WHITE_LATEX_GOAT_AMBIENT.get();
    }
}
