...
/**
 * Dark latex infected version of a horse. Now hostile.
 */
public class DarkLatexHorseEntity extends Horse {
    public DarkLatexHorseEntity(EntityType<? extends Horse> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.DARK_LATEX_HORSE_AMBIENT.get();
    }
}
