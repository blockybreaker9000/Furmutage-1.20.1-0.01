...
/**
 * Dark latex infected version of a sheep. Now hostile.
 */
public class DarkLatexSheepEntity extends Sheep {
    public DarkLatexSheepEntity(EntityType<? extends Sheep> pEntityType, Level pLevel) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.DARK_LATEX_SHEEP_AMBIENT.get();
    }
